...
export const ItemGroupPage = () => {
  ...
  const fetchAndSetItemGroups = async () => {
    setLoading(true);
    try {
      const data = await getAllItemGroups();
      setItemGroups(data);
    } catch (err) {
  ...
  const handleDelete = async (itemGroup: ItemGroup) => {
    if (window.confirm("Are you sure you want to delete this Item Group?")) {
      setLoading(true);
      try {
        await deleteItemGroup(itemGroup.id);
        await fetchAndSetItemGroups();
                        ...
                        >
                          <button
                            ...
                            onClick={() => {
                              ...
                              navigate(`/itemgroup/edit/${group.id}`);
                            }}
                          >
                            Edit
                          </button>
