...
import { FaMoneyBillWave, FaFileAlt, FaHashtag, FaProjectDiagram, FaTimes } from "react-icons/fa";

const RevenueDrawer: React.FC<{
  isOpen: boolean;
  onClose: () => void;
  revenue: any;
}> = ({ isOpen, onClose, revenue }) => {
          ...
          <div className="p-6 overflow-y-auto pt-12">
            <div className="flex items-center mb-6">
              <div className="bg-blue-100 dark:bg-blue-900 p-3 rounded-lg mr-4">
                <FaMoneyBillWave className="text-blue-600 dark:text-blue-300" size={24} />
              </div>
              <div>
                <h2 className="text-2xl font-bold text-gray-800 dark:text-white">
                  {revenue.revenue_code}
                </h2>
                <p className="text-gray-600 dark:text-gray-300">Revenue Details</p>
              </div>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                <div className="flex items-center mb-3">
                  <FaFileAlt className="text-gray-500 dark:text-gray-300 mr-2" />
              ...
              <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                <div className="flex items-center mb-3">
                  <FaHashtag className="text-gray-500 dark:text-gray-300 mr-2" />
                  <h3 className="font-semibold text-gray-700 dark:text-white">
                    Revenue Code
                  </h3>
                </div>
