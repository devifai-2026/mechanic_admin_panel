...
import { FaCalendarAlt, FaUser, FaBuilding, FaCheckCircle, FaTimesCircle, FaClock } from "react-icons/fa";
...
const ConsumptionSheetDetailpage = () => {
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto bg-white dark:bg-gray-900 rounded-lg shadow">
      ...
      <h1 className="text-2xl font-bold mb-6">Consumption Sheet Details</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
        ...
        <InfoCard
          icon={<FaUser />}
          label="Created By"
          value={requisition.createdByUser?.emp_name || "N/A"}
        />
        <InfoCard
          icon={<FaBuilding />}
          label="Organisation"
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
        <InfoCard
          icon={getApprovalStatusIcon(requisition.is_approved_mic)}
          label="Mechanic Incharge"
          value={
            <span className={
              requisition.is_approved_mic === "approved"
                ? "text-green-600"
                : requisition.is_approved_mic === "rejected"
                ? "text-red-600"
                : "text-yellow-600"
            }>
        ...
        />
        <InfoCard
          icon={getApprovalStatusIcon(requisition.is_approved_sic)}
          label="Site Incharge"
          value={
            <span className={
        ...
        />
        <InfoCard
          icon={getApprovalStatusIcon(requisition.is_approved_pm)}
          label="Project Manager"
          value={
            <span className={
              requisition.is_approved_pm === "approved"
                ? "text-green-600"
                : requisition.is_approved_pm === "rejected"
                ? "text-red-600"
                : "text-yellow-600"
            }>
