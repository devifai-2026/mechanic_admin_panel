...
import { FaCalendarAlt, FaUser, FaBuilding, FaCheckCircle, FaTimesCircle, FaClock, FaSearch } from "react-icons/fa";

const DieselReceiptDetailsPage = () => {
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto bg-white dark:bg-gray-900 rounded-lg shadow">
      ...
      <h1 className="text-2xl font-bold mb-6">Diesel Receipt Details</h1>
...
export default DieselReceiptDetailsPage;