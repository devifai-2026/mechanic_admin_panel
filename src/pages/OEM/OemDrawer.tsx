...
const OemDrawer: React.FC<{
  isOpen: boolean;
  onClose: () => void;
  oem: any;
}> = ({ isOpen, onClose, oem }) => {
  if (!isOpen || !oem) return null;
      ...
      >
        ...
        <div className="p-6 pt-12 flex-grow">
          <div className="mb-6">
            ...
            <p className="text-gray-600 dark:text-gray-300">OEM Details</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <DrawerInfo
              ...
              icon={<FaCalendarAlt />}
              value={
                oem.createdAt ? new Date(oem.createdAt).toLocaleString() : "-"
              }
            />
            <DrawerInfo
              title="Updated At"
              icon={<FaCalendarAlt />}
              value={
                oem.updatedAt ? new Date(oem.updatedAt).toLocaleString() : "-"
              }
            />
          </div>
